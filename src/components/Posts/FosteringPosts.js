      ...
      <section className="p-5">
        <div className="container-fluid mb-3">
          <div className="lost-wrapper">
            <h3 className="lost-title"> Fostering. In adoption we trust.</h3>

          </div>
          <hr  />
        </div>
        <div className="d-flex flex-wrap justify-content-between py-3">
          <div className="article-pic-3 "></div>
          <div className="w-50">
        ...
        <hr/>
        <div className="d-flex flex-wrap justify-content-between py-3">
          <div className="article-pic-4 "></div>
          <div className="w-50">
            <div className="post-header d-flex justify-content-start flex-wrap mb-2 ">
        ...
        <hr/>
        <div className="d-flex flex-wrap justify-content-between py-3">
          <div className="article-pic-5 "></div>
          <div className="w-50">
            <div className="post-header d-flex justify-content-start flex-wrap mb-2 ">
